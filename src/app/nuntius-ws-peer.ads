...
package Nuntius.Ws.Peer is
   ...
   --  Message; a ping is ponged, a pong dropped, a close echoed then
   --  Closed; a binary, continuation, reserved or oversize frame is
   --  answered with a close and Faulted.  Closed and Faulted both
